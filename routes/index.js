...
router.get('/', function (req, res, next) {
    var Canvas = require('canvas'), canvas = new Canvas(400, 400 * 2 / 3), ctx = canvas.getContext('2d'), fs = require('fs'), fractalizer = new Fractalizer();
    fractalizer.render(ctx, canvas.width, canvas.height);
    var out = fs.createWriteStream(__dirname + '/../public/images/state.png'), stream = canvas.createPNGStream();
